...
| 5 | `05-demo-a` | 430s | 전체화면 **녹화 삽입 영역** — 하단 띠에 진행 중인 단계와 단축키 (1/3) | 6 |
| 6 | `05-demo-b` | 618s | 전체화면 **녹화 삽입 영역** — 하단 띠에 진행 중인 단계와 단축키 (2/3) | 8 |
| 7 | `05-demo-c` | 162s | 전체화면 **녹화 삽입 영역** — 하단 띠에 진행 중인 단계와 단축키 (3/3) | 2 |
| 8 | `06-check` | 152s | 확인 카드 4장 + 하단 문단 | 4 |
| 9 | `07-recap` | 136s | 2분할 마무리 | 2 |
| 10 | `08-keys` | 130s | 오늘 친 단축키 표 + 기능키 | 15 |
| 11 | `09-closing` | 14s | 인사 — 검정 바탕 · 「고생하셨습니다」 · 다음 차시 | 2 |
