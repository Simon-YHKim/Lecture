...
| # | 파일 | 길이 | 화면 | 비트 |
| --- | --- | --- | --- | --- |
| 1 | `01-title` | 12s | 검정 타이틀 · **원·호·오프셋** | — |
| 2 | `02-today` | 139s | 왼쪽 카드 4장(마크 포함) / 오른쪽 정면도 | 4 |
| 3 | `03-concept` | 223s | 개념 카드 4장 + 하단 문단 | 4 |
| 4 | `04-on-the-drawing` | 335s | 왼쪽 도면 / 오른쪽 표 6행 — 행마다 도면의 해당 위치가 붉어진다 | 6 |
| 5 | `05-demo` | 1210s | 전체화면 **녹화 삽입 영역** — 하단 띠에 진행 중인 단계와 단축키 | 16 |
| 6 | `06-check` | 152s | 확인 카드 4장 + 하단 문단 | 4 |
| 7 | `07-recap` | 136s | 2분할 마무리 | 2 |
| 8 | `08-keys` | 130s | 오늘 친 단축키 표 + 기능키 | 15 |
| 9 | `09-closing` | 14s | 인사 — 검정 바탕 · 「고생하셨습니다」 · 다음 차시 | 2 |
