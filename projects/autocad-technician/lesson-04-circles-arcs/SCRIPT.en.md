...
**Time:** 30:27–32:43
    ...
    (1 card — radius and diameter) First, putting a diameter where the radius goes. The circle command asks for a radius by default. But the drawing gives diameter 25. Put 25 in as it stands and you get a diameter of 50. Exactly twice. And on screen it just looks like a slightly bigger circle. It is hard to notice. Make yourself one habit. If it carries the diameter symbol, press `D` first. If it carries R, put it straight in.
