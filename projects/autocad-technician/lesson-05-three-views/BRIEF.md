...
| # | 파일 | 길이 | 화면 | 비트 |
| --- | --- | --- | --- | --- |
| 1 | `01-title` | 9s | 검정 타이틀 · **제3각법 3뷰와 반복** | — |
| 2 | `02-today` | 106s | 왼쪽 카드 4장(마크 포함) / 오른쪽 정면도 | 4 |
| 3 | `03-concept` | 184s | 개념 카드 4장 + 하단 문단 | 4 |
| 4 | `04-on-the-drawing` | 191s | 왼쪽 도면 / 오른쪽 표 6행 — 행마다 도면의 해당 위치가 붉어진다 | 6 |
| 5 | `05-demo-a` | 498s | 전체화면 **녹화 삽입 영역** — 하단 띠에 진행 중인 단계와 단축키 (1/3) | 6 |
| 6 | `05-demo-b` | 513s | 전체화면 **녹화 삽입 영역** — 하단 띠에 진행 중인 단계와 단축키 (2/3) | 6 |
| 7 | `05-demo-c` | 472s | 전체화면 **녹화 삽입 영역** — 하단 띠에 진행 중인 단계와 단축키 (3/3) | 4 |
| 8 | `06-check` | 132s | 확인 카드 4장 + 하단 문단 | 4 |
| 9 | `07-recap` | 103s | 2분할 마무리 | 2 |
| 10 | `08-keys` | 120s | 오늘 친 단축키 표 + 기능키 | 12 |
| 11 | `09-closing` | 21s | 인사 — 검정 바탕 · 「고생하셨습니다」 · 다음 차시 | 2 |
