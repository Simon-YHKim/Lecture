...
| # | 파일 | 길이 | 화면 | 비트 |
| --- | --- | --- | --- | --- |
| 1 | `01-title` | 9s | 검정 타이틀 · **시험 안내와 Q&A** | — |
| 2 | `02-exam` | 92s | 왼쪽 시험 안내 표 6행 / 오른쪽 3뷰 도면 | 6 |
| 3 | `03-qa` | 95s | 질문 카드 5장 — 첫 장은 채점 기준이 들어올 빈자리 | 5 |
| 4 | `04-technician-work` | 73s | 테크니션 업무 카드 3장 (마크 포함) | 3 |
| 5 | `05-field-commands` | 98s | 실무 명령 표 6행 + 하단 연습 안내 | 6 |
| 6 | `06-recap` | 71s | 2분할 마무리 | 2 |
| 7 | `07-closing` | 14s | 인사 — 검정 바탕 · 「고생하셨습니다」 · 과정 완료 | 2 |
