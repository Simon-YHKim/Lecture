...
| z | 위치 |
| --- | --- |
| 0 | 보스 앞면 — 보는 사람에게 가장 가깝다 |
| 8 | 보스와 판이 만나는 면 |
| 20 | 판 뒷면 — 프레임에 밀착한다 |

뒷면은 프레임에 밀착하므로 평면으로 두고 보스는 앞으로 돌출한다.
...
| --- | --- | --- | --- | --- | --- |
| 외형선 | Continuous | 0.30 | — | 초록 (3) | 보이는 모양 |
| 중심선 | CENTER | 0.15 | 0.5 | 빨강 (1) | 중심과 대칭축 |
| 숨은선 | HIDDEN | 0.15 | 0.5 | 노랑 (2) | 가려진 모양 |
| 치수선 | Continuous | 0.15 | — | 흰색 (7) | 치수 · 보조선 · 뷰를 맞추는 투상선 |
...
| --- | --- |
| 평면도 | x=0.000000~32.792639, x=87.207361~120.000000 |
| 우측면도 | y=34.000000~68.615097 |
