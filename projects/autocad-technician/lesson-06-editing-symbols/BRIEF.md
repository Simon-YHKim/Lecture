...
| 5 | `05-demo` | 1390s | 전체화면 **녹화 삽입 영역** — 하단 띠에 진행 중인 단계와 단축키 | 16 |
| 6 | `06-check` | 159s | 확인 카드 4장 + 하단 문단 | 4 |
| 7 | `07-recap` | 185s | 2분할 마무리 | 2 |
| 8 | `08-keys` | 116s | 오늘 친 단축키 표 + 기능키 | 13 |
| 9 | `09-closing` | 25s | 인사 — 검정 바탕 · 「고생하셨습니다」 · 다음 차시 | 2 |
