...
| # | 파일 | 길이 | 화면 | 비트 |
| --- | --- | --- | --- | --- |
| 1 | `01-title` | 6s | 검정 타이틀 · **기준선과 외곽** | — |
| 2 | `02-today` | 119s | 왼쪽 카드 4장(마크 포함) / 오른쪽 정면도 | 4 |
| 3 | `03-concept` | 166s | 개념 카드 4장 + 하단 문단 | 5 |
| 4 | `04-on-the-drawing` | 158s | 왼쪽 도면 / 오른쪽 표 6행 — 행마다 도면의 해당 위치가 붉어진다 | 6 |
| 5 | `05-demo-a` | 266s | 전체화면 **녹화 삽입 영역** — 하단 띠에 진행 중인 단계와 단축키 (1/2) | 6 |
| 6 | `05-demo-b` | 495s | 전체화면 **녹화 삽입 영역** — 하단 띠에 진행 중인 단계와 단축키 (2/2) | 10 |
| 7 | `06-check` | 140s | 확인 카드 4장 + 하단 문단 | 4 |
| 8 | `07-recap` | 135s | 2분할 마무리 | 2 |
| 9 | `08-keys` | 109s | 오늘 친 단축키 표 + 기능키 | 15 |
| 10 | `09-closing` | 14s | 인사 — 검정 바탕 · 「고생하셨습니다」 · 다음 차시 | 2 |
