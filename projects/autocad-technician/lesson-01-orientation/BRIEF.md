...
여덟 차시 과정의 첫 시간이다. 도면을 한 줄도 그리지 않는다.
...
| # | 파일 | 길이 | 화면 | 비트 |
| --- | --- | --- | --- | --- |
| 1 | `01-title` | 13s | 검정 타이틀 · **오리엔테이션** | — |
| 2 | `02-why-drawings` | 127s | 도입 문장 + 요건 카드 5장 + 하단 문단 | 6 |
| 3 | `03-how-assessed` | 73s | 과제 카드 4장 + 하단 문단 | 5 |
| 4 | `04-roadmap` | 127s | 안내 문장 + 로드맵 표(차시·주제·하는 일) | 8 |
| 5 | `05-recap` | 52s | 2분할 마무리 | 2 |
| 6 | `06-closing` | 18s | 인사 — 검정 바탕 · 「고생하셨습니다」 · 다음 차시 | 2 |
