...
| 3 | 기준선과 외곽 | L02_TEMPLATE | L03_PROFILE | 16 | 6단계 뒤 | 7:35 + 12:35 |
| 4 | 원·호·오프셋 | L03_PROFILE | L04_FEATURES | 16 | 6단계 뒤 · 14단계 뒤 | 7:10 + 10:18 + 2:42 |
| 5 | 제3각법 3뷰와 반복 | L04_FEATURES | L05_VIEWS | 16 | 6단계 뒤 · 12단계 뒤 | 9:58 + 10:33 + 9:09 |
| 6 | 편집과 표현 | L05_VIEWS | L06_REPRESENTED | 16 | 7단계 뒤 · 13단계 뒤 | 7:26 + 11:29 + 4:15 |
| 7 | 치수와 출도 | L06_REPRESENTED | L07_RELEASE | 16 | 5단계 뒤 · 14단계 뒤 | 7:56 + 18:19 + 4:25 |
...
지금 타이밍은 Windows 한국어 음성으로 문단마다 실제로 읽혀 잰 값이다
(`LESSON_STYLE.md` 29번). 실제 녹화자가 그보다 빠르거나 느리면 `speech.PACE`
하나로 맞추고, 녹화가 들어오면 실측 시각이 그 값을 통째로 대체한다.
