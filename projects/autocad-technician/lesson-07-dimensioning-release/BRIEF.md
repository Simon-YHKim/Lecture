...
| 2 | `02-today` | 152s | 왼쪽 카드 4장(마크 포함) / 오른쪽 정면도 | 4 |
| 3 | `03-concept` | 167s | 개념 카드 4장 + 하단 문단 | 4 |
| 4 | `04-on-the-drawing` | 279s | 왼쪽 도면 / 오른쪽 표 6행 — 행마다 도면의 해당 위치가 붉어진다 | 6 |
| 5 | `05-demo` | 1840s | 전체화면 **녹화 삽입 영역** — 하단 띠에 진행 중인 단계와 단축키 | 16 |
| 6 | `06-check` | 155s | 확인 카드 4장 + 하단 문단 | 4 |
| 7 | `07-recap` | 182s | 2분할 마무리 | 2 |
| 8 | `08-keys` | 130s | 오늘 친 단축키 표 + 기능키 | 15 |
| 9 | `09-closing` | 26s | 인사 — 검정 바탕 · 「고생하셨습니다」 · 다음 차시 | 2 |
