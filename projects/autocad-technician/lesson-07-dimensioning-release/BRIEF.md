...
| 5 | `05-demo-a` | 270s | 전체화면 **녹화 삽입 영역** — 하단 띠에 진행 중인 단계와 단축키 (1/3) | 5 |
| 6 | `05-demo-b` | 726s | 전체화면 **녹화 삽입 영역** — 하단 띠에 진행 중인 단계와 단축키 (2/3) | 9 |
| 7 | `05-demo-c` | 286s | 전체화면 **녹화 삽입 영역** — 하단 띠에 진행 중인 단계와 단축키 (3/3) | 3 |
| 8 | `06-check` | 131s | 확인 카드 4장 + 하단 문단 | 4 |
| 9 | `07-recap` | 137s | 2분할 마무리 | 2 |
